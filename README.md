...
- How banks can optimize marketing strategies using data-driven insights  
...
4. How does call duration impact conversion success?  
5. Does increasing the number of contact attempts improve outcomes?  
...
- Used appropriate visualizations for categorical and numerical features
...
- **Fewer contact attempts** lead to better outcomes, while excessive follow-ups show diminishing returns.
...
- Use demographic and engagement-based insights to design **targeted and efficient campaigns**.
